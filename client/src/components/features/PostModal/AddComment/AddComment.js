...
export const AddComment = ({ postId, username, commentPost }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      >
        <path
          d="M24 48C10.8 48 0 37.2 0 24S10.8 0 24 0s24 10.8 24 24-10.8 24-24 24zm0-45C12.4
        3 3 12.4 3 24s9.4 21 21 21 21-9.4 21-21S35.6 3 24 3z"
        ></path>
        <path
          d="M34.9 24c0-1.4-1.1-2.5-2.5-2.5s-2.5 1.1-2.5 2.5 1.1 2.5 2.5 2.5 2.5-1.1 2.5-2.5zm-21.8
        ...
        2.1-.2.6.5.7 1.5.2 2.1 0 .2-2.8 3.7-8 3.7z"
        ></path>
      </svg>
      <textarea
